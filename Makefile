...
DIR=IN200
FILES=display/display.c utils/init.c utils/utils.c movements/movements.c
HEADERS=display/display.h utils/init.h utils/utils.h utils/types.h movements/movements.h
